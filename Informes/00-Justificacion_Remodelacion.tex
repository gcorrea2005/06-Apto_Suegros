...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\small\color{black} Ingeniero Contratista}
  \end{center}
...
\newpage
\thispagestyle{plain}
\addcontentsline{toc}{part}{Anexo 6: Registro Fotográfico}
\vspace*{\fill}
\begin{center}
...
\vspace*{\fill}
\newpage
\includepdf[pages=-,pagecommand={\thispagestyle{plain}},scale=0.85,offset=0 0.5cm]{06-Anexo_Fotografico.pdf}
