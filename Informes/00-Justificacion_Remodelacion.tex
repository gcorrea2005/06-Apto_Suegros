...
\titleformat{\section}{\Large\bfseries\color{primary}}{\thesection.}{0.6em}{}[\vspace{-0.2em}\rule{\textwidth}{0.5pt}]
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\textcolor{primary!60!black}{Justificación Técnica -- Remodelación 3 Baños}}
...
\begin{titlepage}
  \centering
  \vspace*{2cm}
  {\color{primary}\rule{\textwidth}{2pt}}\\[0.8cm]
  {\Huge\bfseries\color{primary} JUSTIFICACIÓN TÉCNICA}\\[0.3cm]
  {\Huge\bfseries\color{primary} Y ECONÓMICA}\\[1.2cm]
  {\Large\bfseries\color{secondary} Remodelación Integral de 3 Baños}\\[0.4cm]
  {\large Conjunto Residencial Reserva de Granada 3}\\[1.5cm]
  {\color{primary}\rule{\textwidth}{2pt}}\\[1.5cm]

  \begin{minipage}[t]{0.45\textwidth}
    \centering
    {\bfseries Propietario:}\\[0.2cm]
    Francisco Javier Rondon Lagos\\[0.1cm]
    CC 4.251.576
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.45\textwidth}
    \centering
    {\bfseries Dirección:}\\[0.2cm]
    Calle 78 B No. 120-49\\[0.1cm]
    Bloque 1, Apto 401\\[0.1cm]
    Bogotá, Colombia
  \end{minipage}

  \vspace{2cm}
  {\large Junio de 2026}\\[0.5cm]
  \vfill
  {\footnotesize\textcolor{gray!60!black}{Documento elaborado para sustentación técnica, económica y normativa\\del proyecto de remodelación de baños.}}
\end{titlepage}
...
El presente documento tiene como objetivo justificar técnica, estructural, geotécnica y
económicamente la necesidad de realizar una remodelación integral de los tres (3) baños del
...
El inmueble se encuentra en la localidad de Suba, zona noroccidental de Bogotá, sobre los
depósitos de arcilla blanda de alta plasticidad (CH) de la cuenca de la Sabana de Bogotá,
con espesores que alcanzan entre 150 y 300\,m en este sector. Esta condición geotécnica
particular, sumada a la amenaza sísmica intermedia de la región (coeficiente \textit{Aa} =
0.15\,g según NSR-10) y a los efectos de amplificación por cuenca y por altura de la
edificación, genera un escenario de vulnerabilidad sísmica para los elementos no
estructurales que concentran los baños: enchapes, cieloraso, aparatos sanitarios de
porcelana, divisiones de vidrio, tuberías empotradas y accesorios colgantes. La
edificación, con una antigüedad estimada entre 15 y 30 años, fue construida bajo una
...
Realizar la remodelación integral de los tres baños del inmueble, garantizando la
...
Mediante inspección visual y técnica realizada en sitio, se identificaron las siguientes
condiciones y patologías:

\begin{enumerate}[noitemsep]
  \item {\bfseries Enchapes y pisos:} Los enchapes cerámicos existentes presentan desprendimientos,
  fisuras, manchas de humedad y moho en las juntas. El piso muestra desgaste superficial y pérdida
  de color uniforme. Las juntas entre piezas están deterioradas y permiten la filtración de agua.
  \item {\bfseries Instalaciones hidráulicas:} Las tuberías de agua fría y caliente presentan
  signos de corrosión y obstrucciones parciales. Las llaves de corte existentes no funcionan
  ...
  vigente. Los tomas no cuentan con protección GFCI requerida para áreas húmedas. Las
  ...
  estético y funcional. Los sanitarios tienen sistemas de descarga de alto consumo (13 litros por
  descarga). Las griferías presentan goteo y pérdida de acabado cromado.
  \item {\bfseries Cieloraso:} El pañete de techo existente presenta fisuras, manchas de humedad
  ...
  área de piso. Se observan manchas de humedad por capilaridad en la parte inferior de los muros.
...
Comprende la demolición controlada de enchapes cerámicos en muros y pisos, demolición del
pañete de techo existente, desmonte de todos los aparatos sanitarios (sanitarios, lavamanos, duchas,
divisiones de vidrio), desmonte de puntos eléctricos, puertas, ventanas, mesón de mármol y
accesorios. Incluye el cargue, retiro y transporte de escombros a escombrera autorizada.

\subsection{Capítulo 2: Instalaciones Hidráulicas (C02)}

Instalación de nueva red de tubería PVC para agua fría (RDE 21, 200 PSI) y CPVC para agua
caliente, con diámetro mínimo de 1/2\". Se instalarán 16 puntos hidráulicos en total
...
Instalación de 16 puntos eléctricos incluyendo tubería conduit PVC empotrada, cable THHN/THWN
calibre \#12 AWG, cajas octogonales y rectangulares, tomas GFCI con protección diferencial de 5 mA,
apagadores tipo balancín y placas decorativas. Cableado general desde tablero principal con pruebas de
continuidad, aislamiento (megger a 500V) y polaridad.
...
Instalación de cieloraso suspendido en drywall con perfilería metálica galvanizada calibre 26
(canal + omega), placa de yeso de 12.7 mm, masillado de juntas con cinta de papel y joint compound.
Pintura con imprimante sellador y dos manos de vinilo tipo 1 anti-hongos.
...
Instalación de porcelanato en muros formato 30$\times$60 cm con pegante C1 y en pisos formato
60$\times$60 cm con pegante C2. Sistema de doble encolado y nivelación con clips + cuñas.
Boquilla epóxica en todas las juntas. Guardaescoba en porcelanato o aluminio en encuentro muro-piso.
Pendiente mínima del 1\% hacia el desagüe en pisos.
...
Reparación y ajuste de puertas existentes, cambio de cerraduras por chapas de privacidad para baño
con emergencia exterior, instalación de tapetones/junquillos de piso.
...
con cortina antifluido, plafones LED 18W (IP44), apliques LED 12W sobre espejo, extractor/ventilador de
...
y sellado perimetral con silicona estructural, con prueba de estanquidad.
...
\begin{itemize}[noitemsep]
  ...
  \item {\bfseries Decreto 1077 de 2015:} Gestión de Residuos de Construcción y Demolición (RCD).
\end{itemize}

\subsection{Criterios de Diseño y Selección de Materiales}

\begin{enumerate}[noitemsep]
  \item {\bfseries Durabilidad:} Se seleccionaron materiales de alta resistencia al tráfico y a la
  humedad. El porcelanato tiene una absorción de agua inferior al 0.5\% y una dureza superficial
  ...
  monocomando incluyen aireadores que reducen el caudal sin sacrificar la presión percibida.
  \item {\bfseries Eficiencia energética:} Las luminarias LED de 18W (plafones) y 12W (apliques)
  ...
  templado de 6 mm (norma NTC 1522), que al fracturarse se fragmenta en pequeños trozos no cortantes.
  \item {\bfseries Estanquidad:} Sistema integral de impermeabilización con membrana acrílica,
  fieltro geotextil y banda elástica en encuentros, garantizando la protección de la
...
entre 0.8 y 1.2 segundos (mediante la expresión aproximada $T = 0.05\,h^{3/4}$,
NSR-10, Sección A.4.2.2, para una altura aproximada de 40\,m). Este período se
encuentra dentro de la zona de máxima amplificación de la cuenca de Bogotá
(0.5--3.0\,s), lo que implica que la estructura puede experimentar aceleraciones
hasta 2.0--3.0 veces superiores a las que experimentaría en un perfil de suelo
tipo A (roca). El apartamento 401, ubicado en el cuarto piso de una torre de
12 niveles, recibe una amplificación sísmica significativa aunque no la máxima
del edificio (la cual ocurre en los pisos superiores), con aceleraciones de piso
estimadas entre 1.5 y 2.0 veces la aceleración del terreno basal (NSR-10,
Sección A.6.2, perfiles de amplificación por altura para edificios de
mediana altura).
...
Técnica), establece requisitos específicos para la instalación de elementos no
estructurales en edificaciones de los grupos de uso I y II, exigiendo que todos los
componentes y sus anclajes estén diseñados para resistir las fuerzas sísmicas
calculadas según la Sección A.9.4.3.
...
\begin{enumerate}[noitemsep]
  \item {\bfseries Carbonatación:} El dióxido de carbono (\textit{CO}$_{2}$) atmosférico
  penetra en la red porosa del mortero y reacciona con el hidróxido de calcio
  (\textit{Ca(OH)}$_{2}$) presente en la fase acuosa de los poros, reduciendo el pH
  de 12.5--13.0 a valores inferiores a 9.0. Este proceso avanza desde la superficie
  hacia el interior a una velocidad de 1--3\,mm/año en morteros convencionales
  expuestos a ambientes interiores con humedad relativa entre 50 y 70\% (condiciones
  típicas de baños en Bogotá). En una instalación de 20 años, el frente de carbonatación
  puede haber alcanzado 20--60\,mm, superando el espesor típico del mortero de
  pega (10--15\,mm), lo que implica que el mortero está completamente carbonatado
  ...
  cristalización, que puede alcanzar hasta 20\,MPa en condiciones de baja
  humedad relativa (Le Métayer-Levrel et al., 1999), genera fuerzas expansivas
  que desprenden el enchape de su soporte. Las eflorescencias son particularmente
  agresivas en Bogotá debido a la alta concentración de sulfatos en las arcillas
  de la cuenca.
...
directa (método pull-off, norma ASTM C1583 / NTC 6004) realizados en edificaciones
de edad y tipología similar en Bogotá reportan valores de resistencia a la tracción
en la interfaz mortero-soporte del orden de 0.15--0.35\,MPa, muy por debajo del
valor mínimo recomendado de 0.5\,MPa establecido en la NTC 4321 (Baldosas
Cerámicas) y la guía técnica del ICONTEC para instalación de enchapes en interiores.
El nuevo sistema de instalación propuesto (pegante cementoso tipo C1 para muros y
C2 para pisos, según clasificación ISO 13007 / NTC 6106) garantiza resistencias de
adherencia superiores a 1.0\,MPa después de 28 días de curado, con una relación
a/c controlada de 0.35--0.40 y una retracción lineal inferior al 0.1\%.
...
altamente compresibles, con índices de compresión (\textit{Cc}) entre 0.3 y 0.8,
y coeficientes de consolidación (\textit{Cv}) del orden de 1$\times$10$^{-8}$ a
5$\times$10$^{-8}$\,m$^{2}$/s (Alfaro et al., 2001). Esto implica que los
asentamientos por consolidación primaria pueden extenderse por décadas después de
la construcción del edificio. Para una edificación de 4 pisos con una carga
transmitida al suelo del orden de 50--80\,kPa, el asentamiento total estimado
puede alcanzar 5--15\,cm, de los cuales el 30--50\% ocurre durante la
construcción y el 50--70\% restante ocurre a lo largo de la vida útil del edificio
(consolidación secundaria + fluencia lenta o creep). Dado que el edificio tiene
entre 15 y 30 años de antigüedad, es probable que los asentamientos por
consolidación primaria estén en su etapa final, pero los asentamientos por
consolidación secundaria (compresión viscosa o creep) continúan a una tasa del
orden de 0.5--2.0\,mm/año.
...
\begin{itemize}[noitemsep]
  ...
  ($\delta$/L) puede alcanzar valores de 1/300 a 1/500 en edificaciones
  sobre arcillas blandas, superando el l\'{\i}mite de 1/500 recomendado por
  Skempton \& MacDonald (1956) para evitar da\~{n}os estructurales. Las fisuras
  caracter\'{\i}sticas por distorsi\'{o}n angular son diagonales (45\textdegree)
  en muros y siguen las juntas de mortero.
...
donde el nivel freático puede fluctuar entre 2 y 8\,m de profundidad según la
época del año. El agua asciende a través de la red capilar de los materiales de
cimentación y muros (concreto, mortero, ladrillo) por el principio de tensión
superficial, alcanzando alturas de hasta 1.5\,m sobre el nivel del terreno
en materiales con porosidad fina (radio capilar 0.1--10\,$\mu$m). La altura
de ascenso capilar está determinada por la ecuación de Jurin:
\textit{h = 2 $\gamma$ cos$\theta$ / ($\rho$ g r)}, donde \textit{$\gamma$} es la
tensión superficial del agua (72.8\,mN/m a 20\textdegree{}C), \textit{$\theta$} el
ángulo de contacto (variable según el material), \textit{$\rho$} la densidad del
agua, \textit{g} la gravedad y \textit{r} el radio capilar.
...
\begin{itemize}[noitemsep]
  ...
  se instalan con los diámetros mínimos exigidos por el RAS 2000 (Título B):
  sanitarios 4'', lavamanos y duchas 2'', con pendientes mínimas del 2\% para
  diámetros $\leq$ 3'' y del 1\% para diámetros $\geq$ 4''. La instalación
  original presentaba pendientes insuficientes (<1\%) que generaban
  obstrucciones recurrentes por acumulación de sólidos.
...
El presupuesto del proyecto se ha estructurado bajo la metodología de Análisis de Precios
Unitarios (APU), considerando costos de materiales, mano de obra, equipos y transporte a precios de
...
(junio 2026). El AIU incluye Administración (15\%), Utilidad (10\%) e IVA (19\% sobre la utilidad).
...
\begin{enumerate}[noitemsep]
  ...
  \item {\bfseries Valorización del inmueble:} Una remodelación integral de baños puede
  incrementar el valor comercial del inmueble entre un 5\% y un 10\%, según estudios del sector
  inmobiliario colombiano.
  \item {\bfseries Prevención de daños estructurales:} La impermeabilización adecuada y la
  renovación de redes hidrosanitarias previenen filtraciones que podrían generar costos de
  reparación estructural mucho mayores (hasta 3--5 veces la inversión de la remodelación).
...
\begin{enumerate}[noitemsep]
  ...
  corregir las patologías identificadas (humedad, fisuras, desprendimientos, instalaciones
  obsoletas) y prevenir daños mayores a la estructura del inmueble.
  \item El proyecto se ajusta a la normatividad colombiana vigente (NSR-10, RETIE, RAS 2000, NTC)
  garantizando la seguridad, calidad y durabilidad de las intervenciones.
  ...
  \item La selección de materiales de alta calidad (porcelanato, grifería cromada,
  sanitarios de doble descarga, luminarias LED) garantiza una vida útil mínima de 15--20 años
  con un mantenimiento mínimo.
  \item El presupuesto ha sido elaborado con precios de mercado actualizados (Homecenter Colombia,
  junio 2026) y estructurado mediante APU detallados que permiten una ejecución transparente y
  controlada.
\end{enumerate}
...
\part*{Anexo 2: APU Detallados por Actividad}
\addcontentsline{toc}{part}{Anexo 2: APU Detallados por Actividad}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}},scale=0.92,offset=0 0.5cm]{02-APUs_Detallados.pdf}

\part*{Anexo 3: Catálogo de Insumos}
\addcontentsline{toc}{part}{Anexo 3: Catálogo de Insumos}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}},scale=0.92,offset=0 0.5cm]{03-Insumos.pdf}

\part*{Anexo 4: Memoria de Cantidades de Obra}
\addcontentsline{toc}{part}{Anexo 4: Memoria de Cantidades de Obra}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}},scale=0.92,offset=0 0.5cm]{04-Memoria_Cantidades.pdf}

\part*{Anexo 5: Especificaciones Técnicas por Capítulo}
\addcontentsline{toc}{part}{Anexo 5: Especificaciones Técnicas por Capítulo}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}},scale=0.94,offset=0 0.5cm]{05-Especificaciones_Tecnicas.pdf}
